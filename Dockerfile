...
RUN PACKAGES_TO_INSTALL="sudo curl libc-dev libpcre3-dev pkg-config autoconf gcc make git cron php-pear php-dev php-xdebug php7.4-gd php7.4-xml php7.4-mbstring php7.4-zip php7.4-curl php7.4-fpm nginx supervisor libyaml-dev php7.4-mysql php-phalcon4 libgeoip-dev" && \
